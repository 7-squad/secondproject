<template>
  ...
  <el-table-column type="index" width="55" header-align="center" label="序号"> </el-table-column>
    ...
    <el-table-column prop="email" label="邮箱" header-align="center" show-overflow-tooltip></el-table-column>
    ...
    <el-table-column prop="CustomerType" label="用户类型" header-align="center"></el-table-column>
